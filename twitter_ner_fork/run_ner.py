import os
import pickle
from twitter_ner_fork.NoisyNLP.features import sent2features, DictionaryFeatures, ClusterFeatures, WordVectors
from twitter_ner_fork.NoisyNLP.utils import load_sequences, process_glovevectors

TRAIN_FILE = "../twitter_ner_fork/wnut16_train"
DEV_FILE = "../twitter_ner_fork/wnut16_dev"
HEGE_TRAIN_FILE = "../twitter_ner_fork/hege.test.tsv"

TWITTER_NER_MODEL_FILE = "../twitter_ner_fork/twitter_ner%s_model.pkl"

DICTIONARY_DIR = "../twitter_ner_fork/data/cleaned/custom_lexicons/"
WORDVEC_FILE_RAW = "../glove.twitter.27B.200d.txt"
WORDVEC_FILE_PROCESSED = "../glove.twitter.27B.200d.txt.processed.txt"
GIMPLE_TWITTER_BROWN_CLUSTERS_DIR = "../twitter_ner_fork/50mpaths2"
TEST_ENRICHED_DATA_BROWN_CLUSTER_DIR = "../twitter_ner_fork/brown_clusters%s"
TEST_ENRICHED_DATA_CLARK_CLUSTER_DIR = "../twitter_ner_fork/clark_clusters%s"
